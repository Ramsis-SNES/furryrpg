...
; -------------------------- Memory map
	...
	.DEFINE ADDR_SRAM_SLOT1		$B06000
	.DEFINE ADDR_SRAM_SLOT1CHKSUM	$B067FC
	.DEFINE ADDR_SRAM_SLOT2		$B06800
	.DEFINE ADDR_SRAM_SLOT2CHKSUM	$B06FFC
	.DEFINE ADDR_SRAM_SLOT3		$B07000
	.DEFINE ADDR_SRAM_SLOT3CHKSUM	$B077FC
	.DEFINE ADDR_SRAM_SLOT4		$B07800
	.DEFINE ADDR_SRAM_SLOT4CHKSUM	$B07FFC
