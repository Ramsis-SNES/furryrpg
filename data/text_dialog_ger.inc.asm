...
; --------------------------------------------------------------------------------
	.DB CC_Indent, "Hab mich halt um meinen eigenen Kram gek", uuml, "mmert.", CC_End

STR_DialogGer0031:
	.DB CC_Portrait, 2, CC_BoxBlue
	.DB "LILY:", CC_NewLine
	.DB CC_Indent, "Also gut. Um es kurz zu machen, in letzter Zeit", CC_NewLine
	.DB CC_Indent, "verschwinden st", auml, "ndig spurlos irgendwelche Sachen.", CC_ClearTextBox
; --------------------------------------------------------------------------------
	.DB CC_Indent, "Dauerwurst verschwindet aus den Vorratskammern,", CC_NewLine
	.DB CC_Indent, "W", auml, "sche und Schuhe sind abhandengekommen, und", CC_NewLine
	.DB CC_Indent, "sogar Werkzeuge und Angelruten l", ouml, "sen sich in Luft auf,", CC_NewLine
	.DB CC_Indent, "wenn kurz niemand hinschaut.", CC_ClearTextBox
; --------------------------------------------------------------------------------
@Jump01:
	.DB CC_Indent, "Der Kleine meiner Fuchsennachbarn behauptet", CC_NewLine
	.DB CC_Indent, "sogar, er h", auml, "tte den ,,Geist\", der daf", uuml, "r verantwortlich", CC_NewLine
	.DB CC_Indent, "ist, mit seinen eigenen Augen gesehen ...", CC_End
...
STR_DialogGer0084:
	.DB CC_Portrait, 0, CC_BoxBlue
	.DB "GEISSENB", Uuml, "RGERMEISTER:", CC_NewLine
	.DB CC_Indent, "Und Alexis Moreflaw, lange nicht gesehen ... Sir Greyfur,", CC_NewLine
	.DB CC_Indent, "jede Gefellschaft hat nun einmal ihren eigenen Bajazzo,", CC_NewLine
	.DB CC_Indent, "da stellt unser Dorf keine Ausnahme dar.", CC_End

STR_DialogGer0085:
	.DB CC_Portrait, 0, CC_BoxAlert
	.DB "ALEC:", CC_NewLine
	.DB CC_Indent, "Ich hei", szlig, "e immer noch ALEC MARLOWE!", CC_NewLine
	.DB CC_Indent, "Und was zum Geier ist ein ,,Palazzo\"!?", CC_End

STR_DialogGer0086:
	.DB CC_Portrait, 2, CC_BoxBlue
	.DB "LILY:", CC_NewLine
	.DB CC_Indent, "Pssst ... Mach dir nix draus, Alec.", CC_End
...
STR_DialogGer0169:
	...
	.DB CC_Indent, "von R", auml, "ucherwurst in der Nase, wie sie Tusker", CC_NewLine
	.DB CC_Indent, "vermisst hat?", CC_End
