...
;
; To assemble:
; wla-spc700 -v -o spc700-driver-custom.o spc700-driver-custom.asm
; wlalink -b -v spc700-driver-custom.lnk spc700-driver-custom.bin
...
.REPEAT 31					; no. of zeroes required after CUSTOMizations to align the start of the following table to address $0B00 (in sound RAM) = $0902 (in driver .BIN file)
	.DB 0
.ENDR
